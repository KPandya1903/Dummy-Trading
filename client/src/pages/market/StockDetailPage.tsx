...
import StockNewsPanel from '../../components/content/StockNewsPanel';
...
import ValuationContextPanel from '../../components/analysis/ValuationContextPanel';
  ...
  return (
    <>
      ...
      <Box display="flex" gap={2} flexWrap="wrap" mb={3}>
        ...
        <Button
          component={RouterLink}
          to={`/stocks/${quote.ticker}/options`}
          variant="outlined"
          size="large"
        >
          Options Chain
