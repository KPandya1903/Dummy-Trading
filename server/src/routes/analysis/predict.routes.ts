...
import type { OHLCV, EnsembleConfig } from '../../services/prediction/index.js';
...
let _runEnsemble: typeof import('../../services/prediction/index.js').runEnsemble | null = null;
async function getRunEnsemble() {
  if (!_runEnsemble) {
    const mod = await import('../../services/prediction/index.js');
