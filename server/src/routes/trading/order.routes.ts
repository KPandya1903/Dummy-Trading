...
import { checkSufficientShares, checkSufficientCash } from '../../services/trading/tradeValidation.js';
...
router.post('/', async (req: Request, res: Response) => {
  try {
    ...
    if (side === 'SELL') {
      ...
      // For BUY limit/stop orders, validate cash against target price (worst-case cost)
      const cashError = checkSufficientCash(tradeInputs, portfolio.startingCash, Number(targetPrice), Number(quantity));
